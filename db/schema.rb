...
ActiveRecord::Schema[8.0].define(version: 2025_04_21_224509) do
  ...
  create_table "lesson_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["lessons_id"], name: "index_lesson_topics_on_lessons_id"
  ...
  add_foreign_key "lesson_topics", "lessons", column: "lessons_id"
  add_foreign_key "lesson_topics", "topics", column: "topics_id"
